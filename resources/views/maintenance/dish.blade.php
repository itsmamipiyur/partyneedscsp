...
@section('content')
	...
	<div class="row">
		<button type="button" class="ui green button" onclick="$('#create').modal('show');" style="background-color: rgb(0,128,0);"><i class="add icon"></i>New Dish</button>
		<a href="{{ url('/archive/dish') }}" style="background-color: rgb(0,128,128);" class="ui teal button"><i class="archive icon"></i>Archive</a>
	</div>
	<div class="row">
